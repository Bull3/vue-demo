<template>
  <div class="container">
   <gantt class="left-container" v-bind="$attrs"/> 
   <!-- <gantt2 class="left-container" v-bind="$attrs"/> -->
    <!-- <gantt
    ...
    <!-- <div class="right-container">
      ...
      <ul class="gantt-messages">
        <li class="gantt-message" v-for="(message, index) in messages" :key="'li_' + index">{{message}}</li>
      </ul>
    </div> -->
  </div>
</template>
