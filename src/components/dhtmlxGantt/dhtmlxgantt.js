...
!function(t, e) {
        ...
        t.exports = function(t) {
            return {
                ...
                isWorkTimeArguments: function() {
                    var e, i = arguments[0];
                    return i instanceof a ? i : ((e = i.date ? new a(i.date,i.unit,i.task,null,i.calendar) : new a(arguments[0],arguments[1],arguments[2],null,arguments[3])).unit = e.unit || t.config.duration_unit,
                    e)
                },
                getClosestWorkTimeArguments: function(e) {
                    var i, n = arguments[0];
                    return n instanceof o ? n : (i = r.isDate(n) ? new o(n) : new o(n.date,n.dir,n.unit,n.task,null,n.calendar),
                    n.id && (i.task = n),
                    i.dir = n.dir || "any",
                ...
                _getStartEndConfig: function(e) {
                    var i, n = l;
                    return e instanceof n ? e : (r.isDate(e) ? i = new n(arguments[0],arguments[1],arguments[2],arguments[3]) : (i = new n(e.start_date,e.end_date,e.task),
                    e.id && (i.task = e)),
                ...
                calculateEndDateArguments: function(e, i, n, a) {
                    var o, l = arguments[0];
                    return l instanceof s ? l : (o = r.isDate(l) ? new s(arguments[0],arguments[1],arguments[2],void 0,arguments[3],void 0,arguments[4]) : new s(l.start_date,l.duration,l.unit,l.step,l.task,null,l.calendar),
                    l.id && (o.task = l),
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t) {
            ...
            t._reinit = function(i) {
                ...
                this.$layout = this.$ui.createView("layout", i, this.config.layout),
                ...
                function(t) {
                    ...
                    e.contentWindow ? a(t, e.contentWindow) : (t.$root.removeChild(e),
                    a(t, window))
                }(t),
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t) {
            ...
            function o(t) {
                ...
                return (e = parseInt(e.value, 10)) && !window.isNaN(e) || (e = 1),
                e < 0 && (e *= -1),
                e
            }
            return n(r, e),
            r.prototype.render = function(e) {
                var i = "<div class='gantt_time_selects'>" + t.form_blocks.getTimePicker.call(this, e) + "</div>"
                  ...
                  , o = "<div class='gantt_duration' " + r + "><input type='button' class='gantt_duration_dec' value='−'" + a + "><input type='text' value='5' class='gantt_duration_value'" + a + " " + t._waiAria.lightboxDurationInputAttrString(e) + "><input type='button' class='gantt_duration_inc' value='+'" + a + "> " + n + " <span></span></div>";
                return "<div style='height:" + (e.height || 30) + "px;padding-top:0px;font-size:inherit;' class='gantt_section_time'>" + i + " " + o + "</div>"
            }
            ,
            r.prototype.set_value = function(e, i, n, r) {
                var s, l, c, u, d = r, h = e.getElementsByTagName("select"), f = e.getElementsByTagName("input"), _ = f[1], g = [f[0], f[2]], p = e.getElementsByTagName("span")[0], v = r._time_format_order;
                function m() {
                    var i = a.call(t, e, r)
                      , s = o.call(t, e, r)
                ...
                "string" == typeof (s = t._resolve_default_mapping(r)) && (s = {
                    start_date: s
                }),
                l = n[s.start_date] || new Date,
                c = n[s.end_date] || t.calculateEndDate({
                    start_date: l,
                    duration: 1,
                    task: n
                }),
                ...
                t.form_blocks._fill_lightbox_select(h, 0, l, v, d),
                _.value = u,
                m()
            }
            ,
        ...
        t.exports = function(t) {
            ...
            t.isTaskVisible = function(e) {
                if (!this.isTaskExists(e))
                    return !1;
                var i = this.getTask(e)
                  , n = i.start_date ? i.start_date.valueOf() : null
                ...
                renderLine: function() {
                    ...
                    return {
                        render: function(i, n, r) {
                            ...
                            var p = null;
                            if (u.length)
                                for (p = document.createElement("div"),
                                h = 0; h < u.length; h++)
                                    p.appendChild(u[h]);
                            return p
                        },
                ...
                renderHistogram: function() {
                    ...
                    function o(e, i, r, a, o, s, l) {
                        ...
                        var f = function(e, i, n, r) {
                            for (var a = i.getScale(), o = document.createElement("div"), s = 0; s < a.trace_x.length; s++)
                                if (d(s, a, r)) {
                                    var l = a.trace_x[s]
                                      , h = a.trace_x[s + 1] || t.date.add(l, a.step, a.unit)
                                      , f = a.trace_x[s].valueOf()
                                      , _ = Math.min(e[f] / n, 1) || 0;
                                    if (_ < 0)
                                        return null;
                                    var g = Math.min(e[h.valueOf()] / n, 1) || 0
                                      , p = c(_, l, h, i);
                                    p && o.appendChild(p);
                                    var v = u(_, g, i.posFromDate(h));
                                    v && o.appendChild(v)
                                }
                            return o
                        }(r, o, s, l);
                    ...
                    return {
                        render: function(t, r, a) {
                            ...
                            for (var v = 0; v < f.length; v++) {
                                var m = f[v]
                                  , y = h.trace_indexes[m.start_date.valueOf()];
                                if (d(y, h, a)) {
                                    var b = u.histogram_cell_capacity(m.start_date, m.end_date, t, m.tasks);
                                    g[m.start_date.valueOf()] = b || 0;
                                    var k = r.getItemPosition(t, m.start_date, m.end_date)
                                      , w = s(t, k, p, c, u, m);
                                    w && (_.push(w),
                                    e[t.id][y] = w)
                                }
                            ...
                            var x = null;
                            if (_.length) {
                                for (x = document.createElement("div"),
                                v = 0; v < _.length; v++)
                                    x.appendChild(_[v]);
                                var $ = o(t, k, g, c, r, p, a);
                                $ && (x.appendChild($),
                        ...
                        update: function(t, i, r, c) {
                            for (var u = r.$getConfig(), h = r.$getTemplates(), f = r.getScale(), _ = l(t, u.resource_property, f, r), g = t.capacity || r.$config.capacity || 24, p = {}, v = 0; v < _.length; v++) {
                                var m = _[v]
                                  , y = f.trace_indexes[m.start_date.valueOf()]
                                  , b = h.histogram_cell_capacity(m.start_date, m.end_date, t, m.tasks);
                                p[m.start_date.valueOf()] = b || 0;
                                var k = r.getItemPosition(t, m.start_date, m.end_date);
                                if (d(y, f, c)) {
                                    var w = e[t.id];
                                    if (w && w[y])
                                        w && w[y] && !w[y].parentNode && i.appendChild(w[y]);
                                    else {
                                        var x = s(t, k, g, u, h, m);
                                        x && (i.appendChild(x),
                                        e[t.id][y] = x)
    ...
    , function(t, e, i) {
        t.exports = function(t) {
            t.ext || (t.ext = {});
            for (var e = [i(97), i(96), i(95), i(94), i(93), i(92), i(91), i(90)], n = 0; n < e.length; n++)
                e[n] && e[n](t);
            var r = i(89).default;
            t.ext.zoom = new r(t)
        }
    ...
    , function(t, e, i) {
        ...
        var l = function() {
            ...
            t.prototype.sendData = function(t) {
                if (!this._waitMode || "tree" !== this.$gantt.mytype && !this.$gantt._h2) {
            ...
            t.prototype._sendData = function(t, e) {
                ...
                if (t) {
                    ...
                    if ("CUSTOM" !== this._tMode) {
                        ...
                        switch (this._tMode) {
                        case "GET":
                            r.url = s + n.urlSeparator(s) + this.serialize(t, e),
                            r.method = "GET";
                            break;
                        case "POST":
                            r.url = s,
                        ...
                        case "JSON":
                            for (var l in a = {},
                            t)
                                l !== this.action_param && "id" !== l && "gr_id" !== l && (a[l] = t[l]);
                            r.url = s,
                            r.method = "POST",
                    ...
                    var c = this.getState(e)
                      ...
                      , h = function(t) {
                        ...
                        r = t.sid || r,
                        a = t.id || t.tid || a),
                        i.afterUpdateCallback(r, a, n, t)
                    }
                      , f = void 0;
                    if (this._router instanceof Function)
                        f = this._router(d, u, t, e);
                    else if (this._router[d]instanceof Function)
                        f = this._router[d](u, t, e);
                    else
                        switch (c) {
                        case "inserted":
                    ...
                    if (f) {
                        if (!f.then && void 0 === f.id && void 0 === f.tid)
                        ...
                        this._forEachUpdatedRow(function(t) {
                            if (!e && !this._in_progress[t]) {
                                if (this.is_invalid(t))
                                    return;
                                this._beforeSendData(this._getRowData(t), t),
                                this._waitMode && ("tree" === this.$gantt.mytype || this.$gantt._h2) && (e = !0)
                            }
                        })
                    }
                }
                ...
                if (window.JSON) {
                    ...
                    if (s) {
                        var l = s.action || this.getState(i) || "updated"
                          , c = s.sid || i[0]
                          , u = s.tid || i[0];
                        return t.afterUpdateCallback(c, u, l, s),
                        t.finalizeUpdate(),
            ...
            t.prototype.finalizeUpdate = function() {
                ...
                ("tree" === this.$gantt.mytype || this.$gantt._h2) && this.updatedRows.length && this.sendData(),
            ...
            t.prototype._getRowData = function(t) {
                var e;
                e = "task" === this.getGanttMode() ? this.$gantt.isTaskExists(t) ? this.$gantt.getTask(t) : {
                    id: t
                } : this.$gantt.isLinkExists(t) ? this.$gantt.getLink(t) : {
                    id: t
                },
                e = this.$gantt.copy(e);
                var i = {};
                for (var n in e)
                    if ("$" !== n.substr(0, 1)) {
                        var a = e[n];
                        r.isDate(a) ? i[n] = this.$gantt.templates.xml_format !== this.$gantt.templates.format_date ? this.$gantt.templates.xml_format(a) : this.$gantt.templates.format_date(a) : i[n] = null === a ? "" : a
                    }
                var o = this.$gantt._get_task_timing_mode(e);
                return o.$no_start && (e.start_date = "",
                e.duration = ""),
                o.$no_end && (e.end_date = "",
                e.duration = ""),
                i[this.action_param] = this.$gantt.getUserData(t, this.action_param),
                i
            }
            ,
                        ...
                        return t = function(t, e) {
                            ...
                            return {
                                ...
                                _resize: function(i, n, r) {
                                    ...
                                    i.end_date - i.start_date < a.min_duration && (r.left ? i.start_date = e.calculateEndDate({
                                ...
                                _update_on_move: function(i) {
                                    ...
                                    if (a.mode) {
                                        ...
                                        if (this._handlers[a.mode]) {
                                            if (e.isSummaryTask(u) && e.config.drag_project && a.mode == o.drag_mode.move) {
                                                var d = {};
                                                d[a.id] = r.copy(a);
                                                var h = this._find_max_shift(r.mixin(d, this.dragMultiple), c);
                                                for (var f in void 0 !== h && (c = h),
                                                this._update_item_on_move(c, a.id, a.mode, a, i),
                                                this.dragMultiple) {
                                                    var _ = this.dragMultiple[f];
                                                    this._update_item_on_move(c, _.id, _.mode, _, i)
                                                }
                                            } else
                                                this._update_item_on_move(c, a.id, a.mode, a, i);
                                ...
                                on_mouse_up: function(i) {
                                    ...
                                    if (n.mode && n.id) {
                                        var r = t.$getConfig()
                                          , a = e.getTask(n.id)
                                          , o = this.dragMultiple;
                                        if (e.isSummaryTask(a) && r.drag_project && n.mode == r.drag_mode.move)
                                            for (var s in o)
                                ...
                                _start_dnd: function(i) {
                                    ...
                                    if (r["drag_" + n.mode] && e.callEvent("onBeforeDrag", [a, n.mode, i]) && this._fireEvent("before_start", n.mode, [a, n.mode, i])) {
                                        delete n.start_drag;
                                        var o = e.getTask(a);
                                        e.isSummaryTask(o) && e.config.drag_project && n.mode == r.drag_mode.move && e.eachTask(function(t) {
        ...
        t.exports = function(t) {
            ...
            function c(n, a, o, s, l, c, u) {
                ...
                if (function(e, i, n) {
                    ...
                    f && (h += " " + f),
                    _.className = h,
                    t.config.smart_rendering && (_.style.position = "absolute",
        ...
        t.exports = function(t) {
            ...
            n.mixin(r.prototype, {
                ...
                set_value: function(e, i, n, r) {
                    this.get_input(r).value = o(e, n.editor, t)
                },
                get_value: function(t, e, i) {
                    return a(this.get_input(i).value || "", e.editor)
                },
                save: function(e, i, n) {
                    var r = s(t.getTask(e), this.get_value(e, i, n));
                ...
                is_changed: function(e, i, n, r) {
                    var s = this.get_value(i, n, r)
                      , l = a(o(e, n.editor, t), n.editor);
                    ...
                    var a = h(t)
                      ...
                      , l = {
                        ...
                        locateCell: function(t) {
                            if (!u.isChildOf(t, n.$grid))
                                return null;
                            var e = u.locateAttribute(t, n.$config.item_attribute)
                              , i = u.locateAttribute(t, "data-column-name");
                            if (i) {
          ...
          , s = function(t) {
            ...
            e.prototype._mouseWheelHandler = function(t) {
                ...
                if (this._checkWheelTarget(e)) {
                    ...
                    if (!t.shiftKey || t.deltaX || t.wheelDeltaX || (r = 2 * a,
                    a = 0),
                    r && Math.abs(r) > Math.abs(a)) {
                        ...
                        var s = r / -40
                          , l = this._oldLeft
                          , c = l + 30 * s;
                        if (this.scrollHorizontally(c),
                        this.$scroll_hor.scrollLeft = c,
                        ...
                        void 0 === a && (s = t.detail);
                        var u = this._oldTop
                          , d = this.$scroll_ver.scrollTop + 30 * s;
                        if (this.scrollVertically(d),
                        this.$scroll_ver.scrollTop = d,
                        u == this.$scroll_ver.scrollTop)
                            return !0;
                        this._oldTop = this.$scroll_ver.scrollTop
                    }
    ...
    , function(t, e, i) {
        ...
        ).call(this, i(41), i(19), i(155).setImmediate)
    }
    , function(t, e, i) {
        t.exports = i(156)
    }
    ...
    , function(t, e, i) {
        ...
        t.exports = function() {
            ...
            ;
            i(166)(t),
            t.$services = t.$inject(i(165)),
            t.config = t.$inject(i(164)),
            t.ajax = i(163)(t),
            t.date = i(161)(t);
            var e = i(160)(t);
    ...
    , function(t, e, i) {
        var n = {
            ...
            getGanttInstance: function() {
                for (var t = i(168)(), e = 0; e < n._ganttPlugin.length; e++)
                    n._ganttPlugin[e](t);
